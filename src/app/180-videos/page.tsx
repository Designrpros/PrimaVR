...
// Sample 180-degree video data (placeholders for now)
const videos = [
  {
...
const VideoLibrary180: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>180 Videobibliotek - PRIMA</title>
        <meta name="description" content="Utforsk vårt bibliotek med 180-videoinnhold for eldre." />
      </Head>
      <PageWrapper>
        <FullScreenIntro>
          <Title>180 Videobibliotek</Title>
        ...
        <VideoLibrarySection>
          <Heading>Våre 180 Videoer</Heading>
          <FilterWrapper>
...
export default VideoLibrary180;